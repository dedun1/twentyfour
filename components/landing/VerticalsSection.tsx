      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-foreground mb-3">
              {isAr ? (
                <>مبنية للأعمال اللي عندها تدفق عملاء مستمر</>
              ) : (
                <>
        ...
        <ScrollReveal>
          <div className="text-center mt-8">
            <Link href="/get-started" className="text-sm text-muted-foreground hover:text-foreground underline transition-colors">

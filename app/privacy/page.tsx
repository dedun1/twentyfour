...
export default function PrivacyPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 prose dark:prose-invert">
      ...
      <h2>Your rights</h2>
      <p>
        You can request a copy of your data, ask for corrections, or request deletion at any time by{' '}
        <Link href="/book-call">booking a call</Link> with our team or via the in-app contact options.
      </p>
      <h2>Third-party services</h2>
      <p>
        We use the following third-party services: Supabase (database), Anthropic (AI), Stripe (payments), and SMS or
        email delivery providers when we send messages on your behalf. Each has its own privacy practices.
      </p>
      <h2>Contact</h2>
      <p>

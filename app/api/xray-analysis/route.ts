  ...
  try {
    ...
    const message = await client.messages.create({
      ...
      messages: [
        {
          role: 'user',
          content: `أنت مستشار أعمال خبير متخصص في الأعمال الخدمية الصغيرة والمتوسطة. بناءً على المعلومات التالية عن العمل، حدد أهم الفرص لتطوير العمل وزيادة الإيرادات.
